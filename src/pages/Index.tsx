        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-10">
              Каждая съёмка для меня — это живая история, запечатлённая в моменте.
              Я работаю на важных событиях и берусь за проекты, которые требуют настоящего мастерства.
            </p>
