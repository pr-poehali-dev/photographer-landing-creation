      ...
      <section id="about" className="py-28 container">
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="relative aspect-[4/5] overflow-hidden">
            <img src={WEDDING_IMG} alt="Элара" className="w-full h-full object-cover" />
          ...
          <div>
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Меня зовут Элара. Уже более десяти лет я ищу свет, в котором рождается настоящая красота.
              Моя камера — это инструмент тишины, в которой проявляются самые честные эмоции.
            </p>
            <p className="text-muted-foreground leading-relaxed mb-10">
              Каждая съёмка для меня — это история, рассказанная языком теней и золотого сияния.
              Я работаю по всему миру и берусь за проекты, которые трогают сердце.
            </p>
